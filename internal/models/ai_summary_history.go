...
type AISummaryHistory struct {
	...
	JobType       string `gorm:"size:32;default:summary" json:"job_type"`
	Status        string `gorm:"size:32;default:success" json:"status"`
	TriggerSource string `gorm:"size:32;default:manual" json:"trigger_source"`
	BatchID       string `gorm:"size:64" json:"batch_id"`
